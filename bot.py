...
async def add_reaction(message: Message):  
    """Add reaction to message using your preferred method"""  
    try:
        msgg = str(message)
...
async def startup():  
    ...
    try:  
        await app.send_message(  
            ...
            f"✅ Status: Online\n\n"  
            f"❤️ **Reactions:** Enabled with your preferred method"  
        )  
    except Exception as e:  
...
if __name__ == "__main__":  
    ...
    print(f"😊 Reactions: Enabled with your preferred method")  
    print("=" * 60)  
